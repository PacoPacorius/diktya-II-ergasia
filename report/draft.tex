...
% Ισχύει ότι αν αφήσουμε το πρόγραμμα αρκετή ώρα, η κλήση θα συνεχίζεται αλλά θα σταματήσουμε να στέλνουμε
% πακέτα;; Είναι πρόβλημα αυτό; Πόσο γρήγορα θα συμβεί; Αν φτάσουμε σε αυτό το σημείο μετά από ώρες κομπλέ,
% αν χρειάζεται μόνο 15 λεπτά όμως;
